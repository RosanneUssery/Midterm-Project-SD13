...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `permissionLevel` INT UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
...
START TRANSACTION;
USE `inventorydb`;
INSERT INTO `user` (`id`, `first_name`, `last_name`, `phone`, `email`, `address_id`, `permissionLevel`) VALUES (1, 'Heero', 'Yuy', '1111111111', 'wingzero@gw.com', 1, 2);
INSERT INTO `user` (`id`, `first_name`, `last_name`, `phone`, `email`, `address_id`, `permissionLevel`) VALUES (2, 'Duo', 'Maxwell', '2222222222', 'deathscythe@gw.com', 2, 1);
INSERT INTO `user` (`id`, `first_name`, `last_name`, `phone`, `email`, `address_id`, `permissionLevel`) VALUES (3, 'Trowa', 'Barton', '3333333333', 'heavyarms@gw.com', 1, 1);
INSERT INTO `user` (`id`, `first_name`, `last_name`, `phone`, `email`, `address_id`, `permissionLevel`) VALUES (4, 'Quatre', 'Winner', '4444444444', 'sandrock@gw.com', 2, 1);
INSERT INTO `user` (`id`, `first_name`, `last_name`, `phone`, `email`, `address_id`, `permissionLevel`) VALUES (5, 'Chang', 'Wufei', '5555555555', 'nataku@gw.com', 1, 1);
